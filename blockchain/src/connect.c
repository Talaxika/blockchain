...
iResult send_broadcast_message(Blockchain *blockchain)
{
    ...
    int numBytes = recvfrom(sockfd, responseBuffer, sizeof(Blockchain), 0, (struct sockaddr *)&responseAddr, &responseAddrLen);
    if (numBytes == SOCKET_ERROR) {
        ...
        memcpy(blockchain, responseBuffer, sizeof(Blockchain));
